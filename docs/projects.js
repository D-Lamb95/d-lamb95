const projects = [
{
  ...
  description:
    "Predicted solar and wind energy production using EIA and CIMIS datasets through ARIMA/SARIMA and regression models.",
  ...
  notebook: "https://github.com/D-Lamb95/renewable-energy-forecasting/blob/main/renewable_energy_forecasting.ipynb",
  skills: ["Python", "Pandas", "ARIMA/SARIMA"],
},
  {
